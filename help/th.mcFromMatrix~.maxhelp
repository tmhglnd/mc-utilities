...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 105.0, 435.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 270.0, 330.0, 60.0, 22.0 ],
									"text" : "mc.*~ 0.9"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 30.0, 330.0, 73.0, 22.0 ],
									"text" : "jit.normalize"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Output values from a 1-plane 1-dimensional jitter matrix as an mc signal. One argument needed, the name of the jit.matrix to read from. Turn DSP on/off and make sure you bang the values in the matrix in your main patch for the effect to take place. Optional second argument is the plane number to read from.\t",
									"textcolor" : [ 0.32548999786377, 0.345097988843918, 0.372548997402191, 1.0 ]
								}
