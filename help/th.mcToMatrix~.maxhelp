...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 105.0, 405.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 105.0, 405.0, 74.0 ],
									"text" : "Input an multichannel signal of any channelcount and write those to a 1 dimensional jit.matrix of the same channel count using jit.poke~. Expects one argument, the name of the jit.matrix to write to. This matrix has to be initialized first. The matrix is 1 plane, type float32 and the dimension is adapted to the channelcount.",
									"textcolor" : [ 0.32548999786377, 0.345097988843918, 0.372548997402191, 1.0 ]
								}
