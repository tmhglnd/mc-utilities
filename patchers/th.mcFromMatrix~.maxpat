...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 30.0, 270.0, 29.0, 22.0 ],
					"text" : "t #2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 390.0, 62.0, 22.0 ],
					"text" : "mc.trunc~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 307.0, 351.0, 203.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 83.5, 275.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 249.0, 239.0, 150.0, 23.0 ],
					"text" : "portfolio",
					"textjustification" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 30.0, 296.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 249.0, 210.0, 150.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 307.0, 72.0, 22.0 ],
					"text" : "spread 0 $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 239.0, 61.0, 22.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 30.0, 435.0, 137.0, 22.0 ],
					"text" : "mc.jit.peek~ #1 1 #3"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(multi-channel signal) output from matrix",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 30.0, 360.0, 114.0, 22.0 ],
					"text" : "mc.sig~ @chans #2"
				}
