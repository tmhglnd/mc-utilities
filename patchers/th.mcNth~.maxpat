...
,
					"patching_rect" : [ 222.0, 390.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 429.0, 405.0, 191.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 231.0, 275.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 417.0, 129.0, 150.0, 23.0 ],
					"text" : "portfolio",
					"textjustification" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 177.5, 296.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 417.0, 100.0, 150.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 525.0, 92.0, 22.0 ],
					"text" : "mc.mixdown~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Arguments: <number-of-channels-input><nth-selected>\nOutput the nth channel from the multichannel signal input, similar to the zl.nth object. Count from 1.",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 39.5, 379.5, 99.5, 379.5 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
